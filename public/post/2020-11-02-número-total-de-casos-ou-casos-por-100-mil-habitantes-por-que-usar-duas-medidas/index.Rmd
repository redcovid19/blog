...
![](/2020-11-02-número-total-de-casos-ou-casos-por-100-mil-habitantes-por-que-usar-duas-medidas/index_files/post2_image1.PNG)

![Imgur](https://i.imgur.com/pP3WFOA.png)
  
html"<span class='img_container center' style='display: inline-block;'>
    <img alt='test' src='https://i.imgur.com/pP3WFOA.png' style='display:block; margin-left: auto; margin-right: auto;' title='O que está na caixa?!' />
    <span class='img_caption' style='display: block; text-align: center;'>Figura 1: Função como caixa</span>
</span>"
